...
public class ListPagerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        PagerTabStrip tabStrip = (PagerTabStrip) rootView.findViewById(R.id.tab_strip);
        tabStrip.setBackgroundColor(ContextCompat.getColor(getContext(), R.color.toolbar_background));
        tabStrip.setTextColor(ContextCompat.getColor(getContext(), R.color.dark_text));
        tabStrip.setTextSize(TypedValue.COMPLEX_UNIT_PX, getResources().getDimensionPixelSize(R.dimen.textSizeTC3));
        tabStrip.setTabIndicatorColor(ContextCompat.getColor(getContext(), R.color.rdio_blue));
